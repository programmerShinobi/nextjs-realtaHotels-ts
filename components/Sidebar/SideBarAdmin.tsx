                ...
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link href="/admin/dashboard">
                      <div
                        className={`shadow-2lg pl-3 px-4 py-2 mx-auto rounded-md text-left text-sm font-medium cursor-pointer flex items-center transition-colors ${router.pathname == "/admin/dashboard"
